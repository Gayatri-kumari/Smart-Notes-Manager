...
const Noteform = () => { 
    ...
    let {note,noteList,handleNoteModal,handleDrafts,handleNoteChange,handleSubmit,handleCancel,editMode,handleSave,noteRef}=data
    let {title,description,category,customCat,imp,altTitle}=note
